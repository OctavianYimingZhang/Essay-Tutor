---
name: essay-tutor-figures-legends
description: Figure and figure legend workflow for Essay Tutor. Use when the user asks to create, specify, revise, caption, cite, or validate academic figures, BioRender-style schematics, generated visuals, data figures, figure panels, scale labels, source notes, permissions, or submit-ready figure legends.
---
