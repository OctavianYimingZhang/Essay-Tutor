---
name: essay-tutor-docx-formatting
description: Academic Word and DOCX formatting workflow for Essay Tutor. Use when the user asks to create, edit, format, inspect, or export Word documents, DOCX files, PDF-from-DOCX outputs, title style, Arial formatting, margins, line spacing, justified body text, references, tables, or submit-ready academic document layout.
---
